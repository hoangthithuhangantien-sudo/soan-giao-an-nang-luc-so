...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Thu Hằng - Trường  Tiểu học Hùng An - ĐT: 0943424334</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Thu Hằng - Trường Tiểu học Hùng An - ĐT: 0943424334</div>", unsafe_allow_html=True)
